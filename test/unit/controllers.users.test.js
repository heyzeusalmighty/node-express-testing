...
describe('controllers : users', () => {
    ...
    describe('filterByYear()', () => {
        ...
        it('should return all users created on or after (>=) specified year', (done) => {
    ...
    describe('filterByYear() with helper', () => {
        it('should return all users created on or after (>=) specified year', (done) => {
            ...
            fs.readFile(testDataFile, 'utf8', (err, data) => {
                usersController.filterByYear(JSON.parse(data), 2015, (err, total) => {
                    should.not.exist(err);
                    total.length.should.equal(5);
                    done();
                });
            });
        });
